...
import { ButtonBlack, ButtonGold } from "./Button";
...
export const CardDetail: FC<PropsCardDetail> = (props) => {
  ...
  return (
    ...
    >
      <div className="hero flex flex-col p-2 md:px-10 py-10 w-full bg-@Gold2 bg-opacity-80 ">
        <div className="flex flex-row px-10 md:gap-12">
          <div className="card min-h-full max-w-xs  rounded-md hover:scale-105">
            <img
              className="w-full h-full rounded-md opacity-100"
              src={img}
              alt="image"
            />
            <div className="flex flex-col w-full h-16 rounded-b-md pr-2 bg-@Black opacity-70 absolute bottom-0 ">
